...
1. [`AGENTS.md`](./AGENTS.md) — pre-action protocol, engineering rules, skill-first protocol, escalation, founding principles.
   1.5. [`docs/strategy/v4-feature-map-2026-06-11.md`](./docs/strategy/v4-feature-map-2026-06-11.md) — **strategic source of truth**: the 7 platform laws, 6 lifecycle stations, 19-agent mesh, handoff contract, HITL gate matrix, 7-surface IA, and milestones M1–M5. Read before any feature, UX, or positioning work. (Personas remain in [`v3-positioning-circuit-2026-06-10.md`](./docs/strategy/v3-positioning-circuit-2026-06-10.md); session resume: [`docs/planning/v4-rebuild-handoff-2026-06-11.md`](./docs/planning/v4-rebuild-handoff-2026-06-11.md).) **Wedge overlay — read first for UX/scope: [`docs/strategy/v5-chief-of-staff-2026-06-11.md`](./docs/strategy/v5-chief-of-staff-2026-06-11.md) (PM Chief of Staff felt product; v4 = expansion map).**
