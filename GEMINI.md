...
1. [`AGENTS.md`](./AGENTS.md) — pre-action protocol, engineering rules, skill-first protocol, escalation, founding principles.
   ...
   1.65. [`docs/brand/`](./docs/brand/): the build-in-public brand system (positioning · voice · X/LinkedIn/Substack cadence · content well · draft queue). When a non-obvious build insight surfaces, capture it to [`docs/brand/content-well.md`](./docs/brand/content-well.md) and draft in the founder's voice; never post to his accounts without his explicit approval.
