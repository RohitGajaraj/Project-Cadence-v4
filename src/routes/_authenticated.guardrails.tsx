...
export const Route = createFileRoute("/_authenticated/guardrails")({
  ...
  head: () => ({ meta: [{ title: "Guardrails · Cadence" }] }),
});
        ...
        <header className="flex items-end justify-between gap-4">
          <div>
            <h1 className="font-display text-3xl tracking-tight flex items-center gap-2">
              <Shield className="h-6 w-6 text-violet-400" /> Guardrails
            </h1>
            <p className="mt-1 text-sm text-muted-foreground">
              Filter sensitive data, secrets, and prompt-injection attempts on every AI call.
            </p>
          </div>
