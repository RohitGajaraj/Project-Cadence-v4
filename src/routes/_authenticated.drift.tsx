...
function DriftPage() {
  ...
  // Trend by day across all surfaces/models
    ...
    <div className="mx-auto max-w-7xl px-6 py-8 space-y-6">
      <header className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Spot regressions in latency, tokens, cost, and eval score across prompt versions.</p>
        </div>
