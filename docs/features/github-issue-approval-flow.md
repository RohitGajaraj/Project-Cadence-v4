...
1. On `/agents` pick the **Orchestrator**, tick **Start as mission**, and dispatch:
   > _"Take the highest-ICE backlog opportunity, draft a PRD, and open a GitHub issue for engineering. Use idempotency_key = the PRD id."_
...
## 7. What is _not_ in this slice (deferred to Bundle 9 and later)
