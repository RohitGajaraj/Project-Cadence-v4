...
- After sync: open an approved spec → **Generate task graph** → 4 to 12 tasks render dependency-ordered with estimates/owners/deps/risk; the metadata row's "linked tasks" count updates; **Push to Linear** / **Send to Build** still work.
