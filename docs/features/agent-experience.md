...
- Strategy: [`../strategy/v8-calm-front-deep-engine.md`](../strategy/v8-calm-front-deep-engine.md) (structure canon this operationalizes), [`../strategy/archive/v4-feature-map.md`](../strategy/archive/v4-feature-map.md) (the original 6-station / 19-mesh map), [`../strategy/session-decisions.md`](../strategy/session-decisions.md) (the decision entry).
