...
**Last updated:** 2026-06-06 · Lovable (Doc-closure pass for voice + popups + inline mgmt. Contract entries added to `architecture/frontend.md`, `design.md`, `architecture/security.md`; learnings banked to `mem://`.).
