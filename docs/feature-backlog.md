...
| Field | Current |
|---|---|
| 🔨 **Now building** | **— idle —** Web access for agents (Firecrawl-backed `web.*` tools) shipped this turn; ready to start Bundle 5 (E6 Mission Graph). Open from Bundle 6 still: operator-driven end-to-end mission run + forced-restart integration test for FND-RUNTIME 0.9. |
