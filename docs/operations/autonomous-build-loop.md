...
> **⛔ ANTI-DUPLICATION INVARIANT (founder ruling 2026-06-22, after repeated cross-session duplication wasted tokens). Two sessions must NEVER work the same register item. Two rules make that true, and both were being violated:**
