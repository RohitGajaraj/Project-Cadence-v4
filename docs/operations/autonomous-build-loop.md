...
> **⛔ ANTI-DUPLICATION INVARIANT (founder ruling 2026-06-22, after repeated cross-session duplication wasted tokens). Two sessions must NEVER work the same register item. THREE rules make that true, and all three were being violated:**
