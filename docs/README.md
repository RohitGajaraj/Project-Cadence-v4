...
| [`planning/archive/v7-trd-2026-06-14.md`](./planning/archive/v7-trd-2026-06-14.md)       | **v7 Technical Requirements Document (archived, superseded by v10):** code-verified architecture snapshot (Part A) + the M-0 to M-D requirements as What/Why/Where/Acceptance with Built/Partial/Missing tags (Part B). The engineering contract for the v7 canon.            |
| [`planning/SOURCE-OF-TRUTH.md`](./planning/SOURCE-OF-TRUTH.md) | **★ THE SINGLE SOURCE OF TRUTH (front door).** The one file to read: status, build queue, founder rulings, findings, and progress. Read after `active-task.md`. Updated every cycle. (Supersedes the archived `v7-build-status.md` as the build-state tracker.) |
...
| [`planning/archive/v7-prd-2026-06-14.md`](./planning/archive/v7-prd-2026-06-14.md) | **v7 PRD (archived, superseded by v10).** Problem, personas, epics as user stories with acceptance criteria and priorities tied to M-0 to M-D, and the launch-gating success metrics. |
