...
2. **Name the outcome, not the mechanism.** "Quality checks", not "evals". "What we have learned", not "decision lineage". "Changes", not "diff" or "drift". The user-facing label says what the user gets; the mechanism name stays in the engine.
