...
| [v3: Strategic pivot to Circuit](./v3-positioning-circuit-2026-06-10.md)         | 2026-06-10 | Full reposition to Circuit, a B2B Enterprise Product Cockpit. Re-aligns the 12 lifecycle stages, 8 cockpit pillars, target personas, pluggable multi-model substrate, and co-development guidelines.                                                                | Superseded by v4 for scope/IA/GTM; **personas still current** |
...
- **Building a feature, making a UX/positioning decision, or onboarding?** For structure / IA / surface placement and build-order, read **v8 (Calm Front, Deep Engine)** first (the current structure/build canon). For positioning / market, read **v7 (Agentic Product OS, the reset)**. It is the current positioning + build canon (code-verified state, four course-corrections, dual-persona, proof-gated M-0→M-D roadmap; founder rulings in §13). v6 holds the prior canon + engine/IA detail + market appendices; v5 holds the wedge UX detail; v4 governs expansion scope (stations, mesh, M2 to M5); personas in v3. Superseded iterations live in [`archive/`](./archive/).
