...
| --- | --- | --- |
| **THE GUIDING STAR: direction, moat, defense, the core-user lens, market, and the agentic build plan (READ FIRST)** | [**v11 Guiding Star**](./v11-guiding-star.md) + the [**ranked build front**](../planning/feature-dashboard.md) (the v11 items are #1-21) | the standing canon (2026-06-23; supersedes v7 to v10 for *direction*; they remain the detailed reference) |
| **What to build next, why, how it should look and behave, priority + lane** | [**v10 master blueprint**](./v10-master-blueprint.md) | the blueprint (the file-grounded detail under v11) |
...
| **How Cadence actually builds: the code-gen engine dispatch layer (WHO writes the code)** | [**build-driver-and-dispatch.md**](./build-driver-and-dispatch.md) | the build-handoff canon (the `BuildDriver` seam = the code-gen-side twin of `RepoProvider`; hybrid posture: native floor + owned Claude-Agent-SDK / OpenHands + BYO Devin/Codex/Cursor; June-2026 market study; cost/pricing/white-label; phases `BD-1..BD-6`; board group G13, founder-gated; decided 2026-06-28) |
| **Pricing strategy (4-tier model, credit dropdown, value ladder, upgrade narrative)** | [**pricing-strategy.md**](./pricing-strategy.md) | the canonical pricing strategy (2026-06-26; supersedes the 5-tier Anthropic-style packaging from the monetization plan §2.4.1 for PUBLIC pricing) |
...
| --------------------------------------------------------------------------------- | ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------- |
| [**v11: The Guiding Star**](./v11-guiding-star.md) | 2026-06-23 | **⭐ CURRENT standing canon (the guiding star).** Consolidates v7 (positioning) + v8 (structure) + v9 (wedge) + v10 (blueprint) + moat.md with a code-and-live-DB-verified ground-truth audit, an outsider villain/defense pressure-test, the core-user felt-experience + pain-point + future-of-PM lens, market/pricing, the embed-skills Playbook-Registry verdict, the corrected ambient self-initiating North Star, and a concrete agentic build plan (the ranked v11 build front in the [feature dashboard](../planning/feature-dashboard.md), #1-21). **When v11 and an older doc disagree on direction, v11 wins.** | **⭐ Current (guiding star)** |
