...
- **Why come to Cadence when Lovable/Cursor build end-to-end?** See Section 6. Building is the cheap part; we own the expensive part (deciding what is worth building and whether it worked), and we dispatch the builders.
