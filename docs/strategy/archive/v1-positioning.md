...
> _Created: 2026-05-26 · Last updated: 2026-06-19_
...
2. **Spec writing is high-effort, low-value mechanical translation.** PMs spend 30 to 50% of time on PRDs and tickets that are downstream of decisions already made. The traction of ChatPRD, Korey, and similar tools is entirely this pain. `[training-data]`
...
4. **Discovery is shallow and anecdotal.** Most PMs do 4 to 8 customer calls per quarter; support/churn/usage/competitor signals are rarely synthesized. Dovetail's ~$50M ARR proves the JTBD demand for synthesis. `[training-data]`
...
- **IC / Senior PM at 30 to 300 person B2B SaaS**: owns roadmap, runs discovery, writes specs, chases eng. Tool stack: Linear or Jira + Notion + Mixpanel/Amplitude + Intercom/Zendesk + Slack. Pain centroid: spec writing + discovery synthesis.
- **Director of Product / VP Product at Series B to D**: owns multi-initiative coordination, stakeholder updates, roadmap justification to exec. Pain centroid: cross-audience comms + justification artefacts.
...
- **Head of Product at AI-native startup (5 to 25 PMs total)**: owns AI-native workflow definition for their team; evaluating which AI tools to standardize on. Pain centroid: making good AI tool choices and integrating them safely.
...
**Secondary wedge (months 6 to 12): Spec → Ticket Pipeline with Approval Gates** (Wedge B).
...
**Tertiary wedge (months 9 to 15): Stakeholder Update Automation** (Wedge C).
...
**Year 2+: Compose into the Product Memory + Closed-Loop Discovery Engine.** Phases 7 to 9 deliver the long-term moat. _The first year is wedges, not platform._
...
2. **Does Cagan's "product trio" framing match how AI-native startups actually operate?** Many AI-native startups are 5 to 15 people total; the trio collapses to one or two humans.
...
### 1. The YouTube watch (this week, 6 to 10 hours total)

Watch and take notes on:

- **Aakash Gupta**, `youtube.com/@growproduct`, last 5 to 8 videos that match AI-PM / agent / product strategy topics. Note guests + 3 quotes per video.
- **Marty Cagan**, search YouTube for talks from last 12 months. _His SVPG essays at `svpg.com/articles/` are FREE and shorter; read 3 to 5 of the most recent._
- **Pawel Huryn**, `youtube.com/@pawelhuryn`, last 3 to 5 videos on AI-native PM.
- **Lenny's Podcast**, `youtube.com/@LennysPodcast`, 2 to 3 recent episodes that touch AI-PM or product OS.

**Output:** send me 5 verbatim quotes from each (20 total) plus your reactions to which voices most resonate.

### 2. Five real PM conversations (next 2 to 3 weeks)

Cagan's hard-truth feedback: _"Stop building. Talk to ten."_ Even five is enough to start.

- Find 5 PMs at B2B SaaS companies (30 to 300 employees, AI-native or AI-aspiring).
...
- **Section 3 (Status Quo) is heavy on training-data; only 3 to 4 incumbent claims have live source backing.** Treat the rest as directional.
