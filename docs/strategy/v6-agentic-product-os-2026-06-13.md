...
> A–D. Competitive detail: [`docs/references/competitive-landscape-2026-06-11.md`](../references/competitive-landscape-2026-06-11.md).
...
- **Pillar 1 — PM Chief of Staff (felt entry):** the daily ritual. Overnight, agents read everything;
  each morning you get the **2–3 calls that need your judgment**, each with cited evidence + a Critic
...
**Beachhead persona:** the **senior / founding PM at a 50–400-person B2B SaaS company** — owns an area,
...
- **Close the autonomy gap** (Phase 1–2): event-reactor auto-handoff across mid-loop hops, hop-failure
...
- **Team — $59–79/seat/mo.** Shared memory, per-role approval lanes, usage metering + BYOK.
...
1. **Pre-launch:** 15–25 hand-picked design partners, free + weekly feedback; **≥8 must pipe REAL data.**
...
Today's product lands in the **tooling framing ($5–10M)**; the **labor framing ($100M+)** requires the
...
4. **Beachhead:** senior/founding PM at 50–400-person B2B SaaS. (§3)
...
# Appendix B — Runtime reality audit (the gap P1–P2 closes) — verified in code
