...
**Date: 2026-06-16. Status: CURRENT structure / IA / build-order canon.** This doc operationalizes v7's positioning ("simple front, powerful engine") into a concrete surface map, the hybrid build spine, and the forward sequencing. [`v7-agentic-product-os.md`](./v7-agentic-product-os.md) remains the positioning + market canon; v8 governs HOW the product is structured and built. Where a surface/structure decision and v8 disagree, v8 wins; where positioning and v8 disagree, v7 wins.
