...
**Status:** planning + docs landed (build bible, BYOK-removal cascade, MOAT canon `../strategy/moat.md`, credit engine `WM-M10`..`WM-M16` specified). **First WM feature code shipped 2026-06-19: WM-M1 (entitlements core).**
...
- [ ] **WM-F1** - Scope agent memory/runs/roster to workspace. Effort L. No deps. New migration + `src/lib/ai/memory.server.ts`. **NEXT.**
