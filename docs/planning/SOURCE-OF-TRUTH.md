...
>
> **Last updated:** 2026-06-18 (cycle 23: P4-GATE eval-regression merge gate). **Maintainer:** the autonomous build loop, every cycle.
...
5. **NEXT:** the rest as they become the binding constraint: `K2` (rollback/revert-to-revision), then `D4-REPLAY`, `FND-0.5`, `F-BUILDER-MULTIFILE`, `R3-PREFS`, `U6-AUDIT`, `P7-COST-INCIDENT`.
