...
| Field                  | Current                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 🔨 **Now building**    | idle. **`F-COCKPIT-MERGE` shipped this turn** — consolidated Swarm HUD (`/swarm`) and Missions list (`/missions`) into a single tabbed flight deck `/cockpit?tab=agents|missions` with redirects and navigation updates.                                                                                                                                                                                                                                                                                                                                                                                                                   |
| ⏭️ **Next up**         | `F-COCKPIT-MACHINE-MODE` (header toggle: Human Mode ↔ Machine Mode, depends on `F-COCKPIT-MERGE`).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
...
**Last updated:** 2026-06-11 · Antigravity (Consolidated `/swarm` and `/missions` into unified `/cockpit?tab=agents|missions`, redirected old routes, and updated application-wide navigation links).
