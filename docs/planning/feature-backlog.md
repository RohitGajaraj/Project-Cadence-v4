...
| Field                  | Current                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 🔨 **Now building**    | — idle — `F-IA-V4` Phase 1a–1d all shipped: `/missions`, `/govern`, `/product`, `/knowledge`, `/learn` live as tabbed surfaces. All absorbed routes flipped to `beforeLoad` redirects. Pinned rail now: Today · Chat · Missions, with Approvals + Calendar in the sidebar Daily utility row. |
| ⏭️ **Next up**         | `F-DECISIONS-CAPTURE` (wire mission/spec/meeting → Decisions log on `/knowledge?tab=decisions`), or `F-IA-V4` Phase 2 (AppShell pinned-rail spec-literal rewrite + `architecture/frontend.md` closure), or M1 Golden Path next slice. |
...
**Last updated:** 2026-06-11 · Lovable — Daily Approvals + Calendar shortcuts moved out of the floating top-right cluster into a compact sidebar footer row so they no longer overlap the ambient bar or page actions.
