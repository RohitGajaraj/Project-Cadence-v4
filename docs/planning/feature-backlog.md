...
| Field                  | Current                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 🔨 **Now building**    | `F-IA-V4` · Lovable · main — **Phase 1a shipped:** `/missions` surface promoted as the v4 IA "Missions" station, absorbing `/cockpit` + `/swarm` (now redirects). Sidebar + command palette repointed. Remaining surfaces (`/product`, `/knowledge`, `/learn`, `/govern`) require panel-body extractions from existing full-page routes — next slice. |
| ⏭️ **Next up**         | `F-IA-V4` Phase 1b: extract `ControlsPanel` from `/governance` + promote `/govern` surface absorbing observe/governance/guardrails/budgets/evals/drift/prompts; then Product/Knowledge/Learn extractions; then AppShell rewrite to pinned `Home · Chat · Missions`. |
...
**Last updated:** 2026-06-11 · Lovable — F-IA-V4 Phase 1a: `/missions` surface live, absorbs `/cockpit` + `/swarm`.
