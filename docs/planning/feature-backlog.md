...
| Field                  | Current                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 🔨 **Now building**    | — idle — `F-DECISIONS-CAPTURE` ✅ shipped: `/knowledge?tab=decisions` is now a real Decisions log (source + status filters, search, side sheet, manual logging). Missions auto-write a decision on completion; spec approval auto-writes on PRD status flip to `approved`; meeting extracts already wrote, now stamped `source_kind='meeting'`. Mission detail + PRD detail pages got a "Capture as decision" button. Also closed `F-SEC-REALTIME-RLS` by dropping `agent_runs` from the realtime publication (no in-app subscribers). |
| ⏭️ **Next up**         | M1 Golden Path next slice, or remaining v3-audit P1 IA/cockpit/surfaces work. |
