...
| Field                  | Current                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 🔨 **Now building**    | `F-IA-V4` · Lovable · main — **Phase 1a + 1b + 1b-2 shipped:** `/missions` + `/govern` surfaces live. Govern now mounts 9 tabs (Controls · Approvals · Guardrails · Budgets · Prompts · Evals · Analytics · Traces · Drift) and absorbs `/governance`, `/observe`, `/guardrails`, `/budgets`, `/drift`, `/traces`, `/inbox`, `/analytics`, `/evals`, `/prompts` (all redirect). `ControlsPanel`, `EvalsPanel`, `PromptsPanel` extracted under `src/components/governance/`. Remaining surfaces: `/product`, `/knowledge`, `/learn` — next slice. |
| ⏭️ **Next up**         | `F-IA-V4` Phase 1c Product surface (Signals · Opportunities · Specs · Roadmap · Releases). Then Phase 1d Knowledge + Learn, Phase 2 AppShell pinned-rail rewrite to `Home · Chat · Missions`. |
...
**Last updated:** 2026-06-11 · Lovable — F-IA-V4 Phase 1b-2: Prompts + Evals folded into `/govern` (9 tabs); `/evals` and `/prompts` flipped to redirects.
