...
**Last updated:** 2026-06-10 · Antigravity (Relocated scattered documents into features/operations/planning subdirectories; structured backlog under the 8 Cockpit Pillars; created redirection pointers to maintain cross-tool co-development compatibility).
...
_Derived from strategic repositioning to "autonomous product OS." Full reasoning: [`strategy/product-positioning-v2.md`](./strategy/product-positioning-v2.md)._
