...
| Field                  | Current                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 🔨 **Now building**    | idle. **v4 strategic rebuild shipped this turn (docs only)** — new strategic source of truth [`../strategy/v4-feature-map-2026-06-11.md`](../strategy/v4-feature-map-2026-06-11.md) (6 stations · 19-agent mesh · 7-surface IA · milestones M1–M5), stress test, market research, session handoff tracker. PLG wedge → enterprise decided; naming deferred to final activity.                                                                                                                                                                                                                                                                                                |
| ⏭️ **Next up**         | **Milestone M1 "The Golden Path"**, starting with `F-IA-V4` (collapse the IA to the 7 surfaces per v4 map §7; absorb `F-COCKPIT-MACHINE-MODE` into the Missions surface work). Then the M1 demo spine hops in order (see § v4 Feature Map overlay below).                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
**Last updated:** 2026-06-11 · Claude (Cowork) — v4 strategic rebuild: feature map + stress test + competitive landscape + handoff tracker landed; docs rewired (README, plan.md §1/§3, design.md IA, CLAUDE/GEMINI read order, naming deferred).
