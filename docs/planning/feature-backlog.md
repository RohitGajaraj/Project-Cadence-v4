...
**Last updated:** 2026-06-11 · Lovable — `F-IA-V4` doc closure complete. `architecture/frontend.md` now accurately reflects the 9-tab Govern surface (absorbed /observe, /evals, /prompts) and the Observe redirect.
