...
| Field                  | Current                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 🔨 **Now building**    | `F-V5-RITUAL` · Claude Code — v5 Chief-of-Staff Phase A: Today rebuilt as the Calls queue (needs-you call cards: pending approvals + Critic-flagged opps/PRDs with evidence + inline Approve/Reject), actionable brief, Start-mission button, cost chip, Approvals pinned. Spec: `docs/strategy/v5-chief-of-staff-2026-06-11.md`. Prior ship: `F-CRITIC-AGENT` + `F-SCRIBE-CITATIONS` ✅ (M1 Golden Path middle hops). Critic runs inline on every new opportunity + freshly generated PRD; verdict chip on opportunity rows and PRD header opens a side sheet with risks, kill criteria, missing evidence, and a re-run button. `generatePrd` now retrieves up to 8 RAG chunks, asks Gemini for inline `[n]` citations, and persists the chunk list to `prds.citations`; PRD detail page renders a Citations card that deep-links to source signals/docs/meetings. |
