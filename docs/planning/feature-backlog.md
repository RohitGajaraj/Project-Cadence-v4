...
| Field                  | Current                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 🔨 **Now building**    | `F-IA-V4` · Lovable · main — **Phase 1a + 1b + 1b-2 + 1c shipped:** `/missions`, `/govern`, and `/product` surfaces live. `/product` mounts 6 tabs (Signals · Opportunities · Specs · Roadmap · Tasks · Releases) and absorbs `/discovery`, `/opportunities`, `/roadmap`, `/tasks` (redirect) and `/prds` (layout + index redirect, so `/prds/$id` still renders). Panels extracted under `src/components/product/`. Remaining surfaces: `/knowledge`, `/learn` — next slice. |
| ⏭️ **Next up**         | `F-IA-V4` Phase 1d — `/knowledge` (Memory · Docs · Calendar) and `/learn` (Support · Outcomes · Learnings, absorbing the rest of `/outcome`). Then Phase 2 AppShell pinned-rail rewrite to `Home · Chat · Missions`. |
...
**Last updated:** 2026-06-11 · Lovable — F-IA-V4 Phase 1c: `/product` surface live with 6 tabs; `/discovery`, `/opportunities`, `/prds` (via index), `/roadmap`, `/tasks` flipped to redirects.
