...
| Field                  | Current                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 🔨 **Now building**    | `F-IA-V4` · Lovable · main — **Phase 1a + 1b shipped:** `/missions` + `/govern` surfaces live. Govern absorbs `/governance`, `/observe`, `/guardrails`, `/budgets`, `/drift`, `/traces`, `/inbox`, `/analytics` (all redirect). `ControlsPanel` extracted from inline governance route into `src/components/governance/ControlsPanel.tsx`. Remaining surfaces (`/product`, `/knowledge`, `/learn`) + `/evals` + `/prompts` fold-in — next slice. |
| ⏭️ **Next up**         | `F-IA-V4` Phase 1b-2: extract `EvalsPanel` + `PromptsPanel` and add as `/govern` tabs. Then Phase 1c Product surface (signals/opportunities/specs/roadmap/releases), Phase 1d Knowledge + Learn, Phase 2 AppShell pinned-rail rewrite to `Home · Chat · Missions`. |
...
**Last updated:** 2026-06-11 · Lovable — F-IA-V4 Phase 1b: `/govern` surface live, absorbs governance + observe + 6 thin redirects.
