...
| Field                  | Current                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 🔨 **Now building**    | `F-V5-RITUAL` ✅ + `F-V5-MOTHBALL` ✅ **code landed** (parallel agent build; `bun run build:dev` green, touched files lint clean) — demo-account walkthrough (v5 verification bar 1) still pending before flipping fully ✅. Next in queue: `F-V5-SLACK` — **blocked on founder-provided Slack app client ID/secret**. Spec: `docs/strategy/v5-chief-of-staff-2026-06-11.md`. Critic runs inline on every new opportunity + freshly generated PRD; verdict chip on opportunity rows and PRD header opens a side sheet with risks, kill criteria, missing evidence, and a re-run button. `generatePrd` now retrieves up to 8 RAG chunks, asks Gemini for inline `[n]` citations, and persists the chunk list to `prds.citations`; PRD detail page renders a Citations card that deep-links to source signals/docs/meetings. |
