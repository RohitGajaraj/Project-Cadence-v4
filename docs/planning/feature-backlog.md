...
**Last updated:** 2026-06-12 · Lovable — live published app fix corrected: Vite config now loads public backend values before wrapper merge and keeps deterministic public fallbacks for publish builds.
