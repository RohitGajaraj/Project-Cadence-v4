...
| Field                  | Current                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 🔨 **Now building**    | — idle — `F-IA-V4` Phase 2 shipped per operator IA call: pinned rail trimmed to **Today · Chat** (Missions still in Agents group). Floating bottom-right dock kept for **Approvals** + **Calendar** (highest-frequency gates); Calendar in the dock now deep-links to `/knowledge?tab=calendar`. **Calendar also folded in as the default tab of `/knowledge`** (Calendar · Memory · Decisions · Docs). `/calendar` flips to `/knowledge?tab=calendar` redirect, `?meeting=` preserved. |
| ⏭️ **Next up**         | `F-DECISIONS-CAPTURE` (wire mission/spec/meeting → Decisions log on `/knowledge?tab=decisions`), or M1 Golden Path next slice. |
...
**Last updated:** 2026-06-11 · Lovable — Pinned rail trimmed to Today · Chat. Floating Approvals + Calendar dock kept (Calendar in the dock points at `/knowledge?tab=calendar`). Calendar also lives as the default tab of `/knowledge` so the swarm has one substrate (events + memory + decisions + docs) to pull threads from.
