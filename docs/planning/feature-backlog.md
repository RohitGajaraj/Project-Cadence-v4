...
| Field                  | Current                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 🔨 **Now building**    | — idle — `F-IA-V4` Phase 2 shipped per operator IA call: pinned rail trimmed to **Today · Chat** (Missions removed from rail; still in Agents group). Floating Approvals + Calendar dock removed. **Calendar folded in as the default tab of `/knowledge`** (Calendar · Memory · Decisions · Docs). `/calendar` flips to `/knowledge?tab=calendar` redirect, `?meeting=` preserved. |
...
**Last updated:** 2026-06-11 · Lovable — Pinned rail trimmed to Today · Chat; floating Approvals + Calendar dock removed; Calendar absorbed into `/knowledge` as the default tab so the swarm has one substrate (events + memory + decisions + docs) to pull threads from.
