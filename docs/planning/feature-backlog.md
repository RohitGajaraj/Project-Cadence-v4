...
| Field                  | Current                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 🔨 **Now building**    | — idle — `F-IA-V4` Phase 1a–1d all shipped: `/missions`, `/govern`, `/product`, `/knowledge`, `/learn` live as tabbed surfaces. All absorbed routes flipped to `beforeLoad` redirects. Pinned rail now: Today · Approvals · Knowledge · Chat. |
...
**Last updated:** 2026-06-11 · Lovable — F-IA-V4 Phase 1d: `/knowledge` (Calendar · Memory · Decisions · Docs) + `/learn` (Outcomes · Support · Learnings) live; `/calendar`, `/docs`, `/outcome`, `/meetings`, `/meetings/$id` redirected. Knowledge pinned in the workspace rail.
