...
**Last updated:** 2026-06-12 · Lovable — preview root fixed: public auth pages now opt out of SSR so browser-only auth redirects no longer blank the preview during hydration.
