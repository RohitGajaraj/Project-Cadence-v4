...
- [x] **Step 3 — Market + competitor research.** Output: [`../references/competitive-landscape-2026-06-11.md`](../references/competitive-landscape-2026-06-11.md). Headline: end-to-end agent-run PM lifecycle is whitespace; feedback layer commoditizing; build layer solved ($48B vibe-coding); MCP table stakes; governance is the differentiator; bottleneck moved from engineering to product alignment.
- [x] **Step 4 — Stress-test verdict.** Output: [`../strategy/v4-stress-test-2026-06-11.md`](../strategy/v4-stress-test-2026-06-11.md).
...
1. Read this file, then [`../strategy/v4-feature-map-2026-06-11.md`](../strategy/v4-feature-map-2026-06-11.md) (the new source of truth), then [`plan.md`](../../plan.md) §3 (build order) and [`feature-backlog.md`](./feature-backlog.md) (Live status board).
...
| --- | --- |
| `docs/strategy/v4-feature-map-2026-06-11.md` | **Canonical feature scope + agent mesh + IA + milestones (read before any feature work)** |
| `docs/strategy/v4-stress-test-2026-06-11.md` | Why v3 wasn't enough — the argued verdict |
| `docs/references/competitive-landscape-2026-06-11.md` | Market research with links (don't re-research) |
