...
| 47 | ◐ | WM-F3 | RBAC enforcement | Real owner/admin/member/viewer permissions for teams | Monetization | WM-3 | 2026-06-19 | CORE shipped by a parallel session (`2b1c429591`): SECURITY DEFINER RBAC helpers (has_workspace_role / has_account_role) + role-based RLS policies + owner demotion trigger + TypeScript role helpers. Verified: tsc/test 8/8/build green, humanization clean. Live enforcement activates on founder's next publish. Spec: docs/features/rbac.md [~60%] |
