...
>
> **Last updated:** 2026-06-18 12:20 (F3 per-product clustering ◐ · P7 guardrail source ◐ · R3 global bell ◐ · D4 ◐ · H1-TASKS ✅ · O1 provenance ◐ · LCH-01 launch-kit ◐) · **Maintainer rule:** Tier 1, continuous (update in the same commit as any status change).
