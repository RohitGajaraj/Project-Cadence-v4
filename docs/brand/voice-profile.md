...
1. **Write for an intelligent reader; be substantive, never generic.** AI-native and technical substance is wanted, not avoided (see directive 15), because it signals an early adopter who actually builds. Keep it readable so a smart non-specialist follows, explain the one technical idea you lean on, but never flatten it into generic commentary anyone could have written. The bar: a reader spends 30 to 60 seconds and feels they got something genuinely useful. Never explicitly name or describe the audience (see directive 20).
...
7. **Length varies on purpose, and longer is fine when the content earns it.** A post can be two lines or several paragraphs. An X thread can be a single tweet or run to many tweets, as long as the idea genuinely needs the room to be covered fully. Do not truncate real substance just to stay short, and do not pad to look long. A too-brief post that drops the substance is as bad as a bloated one. This applies most to X threads, and occasionally to LinkedIn too, depending on the piece. Match the length to the idea.
...
12. **No CTA. No ending question. Ever.** Never close with "what do you think", "what are you facing", "curious how you...", or any engagement prompt. They read as AI-written and reach-farming. End on his point, a line that lands. A post is his message, not a conversation starter.
13. **Experiential first-person framing.** Every post should sound lived, like it came from his real week: "I've been reflecting on", "I've been working on", "this is what I observed", "these are my insights", "something I keep coming back to", "last weekend I was working on". Past tense, from his own read, build, use, or listen. Vary the phrasing; never turn one opener into a formula.
14. **Anchor to real, specific things, and tag.** When possible, reference a real podcast, article, talk, model, or launch he actually engaged with, name it, and tag the relevant person or guest. His take can agree, partly agree, or genuinely disagree; a real, specific, sometimes-contrarian reaction is what reads as authentic. Never fabricate a source he did not consume. If a real anchor is not certain, leave a clear placeholder for the founder to fill rather than inventing one.
15. **AI-native and technical substance is wanted.** Real, hands-on detail about models, agents, memory, evals, and how the work is actually done is an asset: it signals an early adopter who builds, not a commentator who narrates. Keep it, and explain the one idea a reader needs so a smart non-specialist follows. The only thing out is raw, unexplained engineering with no point behind it.
16. **Time news and launches for impact.** A reaction to a launch, a removal, or an industry moment must go out while it is live and relevant, not after the moment has passed. Prioritize timely items in the running order; never post stale news.
17. **Hashtags: default none.** No hashtag stacks, ever, no piling on #ProductManagement, #AI and the like. At most one, rarely, and only if it is genuinely additive. Stacks read as reach-farming and AI authorship, which is the opposite of the goal. Same restraint on @-tags: only a real, earned mention, never for reach.
18. **The bar: genuine value, never filler.** Every post must leave a reader feeling they learned something or saw a sharp, real point of view. If it reads as generic, scheduled, or machine-made, it fails, however clean it looks.
19. **Ground every post in real experience or fresh, real data.** Each post stands on either something the founder actually did, built, used, read, or heard, or a current, citable data point from real market research, ideally both. Do the research; use fresh, accurate numbers, never invented ones, and sanity-check them before staging. Generic commentary that could have been written without living or reading anything does not ship.
20. **Never name the audience; keep the build implicit.** Do not write "for product people" or "for business folks" or otherwise label who this is for. Be useful to them instead of naming them. What the founder is building stays implicit, surfaced only through the consistency of a hands-on, AI-native, early-adopter point of view, never stated outright.
21. **Show the work, and credit both sides.** When a post draws on something he built or ran, back it with proof when possible (a snippet, a screenshot, a concrete artifact), and frame it as direction, not passive use. Name what he brought (the problem, the references, the constraints, the taste to know what was off) and what the model brought (the engine, the reasoning, the speed). He reads as the one orchestrating the work, not a spectator to it. Get into the real craft detail (design, product, or engineering terms, explained) instead of "I asked it and it did everything." And get the lived facts exactly right (dates, durations, what actually happened); a detail people can disprove kills the whole post.
