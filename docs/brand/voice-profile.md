...
1. **Audience is business and product people, and non-technical readers.** Write so a smart, non-technical product or business person fully gets it on the first read. Plain business-and-product language. Technical detail is allowed in moderation (see directive 15), never raw or unexplained; when used, translate it into plain terms a non-technical reader follows and relates to. The test: if the founder could not comfortably explain a line to a non-technical colleague who asks "what did you mean," it does not ship.
...
13. **Experiential first-person framing.** Every post should sound lived, like it came from his real week: "something I keep coming back to", "last weekend I was working on", "the more I sit with this", "my two cents", "a reflection from this week". Past tense, from his own read, walk, build, or listen. Vary the phrasing; never turn one opener into a formula.
...
15. **Technical is allowed in moderation, not banned.** When a technical point genuinely adds value, keep it and explain it as simply as possible, from the audience's perspective, so a non-technical reader follows and relates. Raw, unexplained engineering is still out.
...
17. **Hashtags and tags: tasteful, few, real.** A small number of genuinely relevant tags per post for reach, never a spammy stack. LinkedIn tolerates two or three; X prefers none to one. Keep them topical to his real domain so they never signal reach-farming, AI authorship, or a sudden job-hunt push. The founder's call to keep or cut.
