...
1. [`AGENTS.md`](./AGENTS.md) — pre-action protocol, engineering rules, escalation, session-friction loop, founding principles.
   1.5. [`docs/strategy/v4-feature-map-2026-06-11.md`](./docs/strategy/v4-feature-map-2026-06-11.md) — **strategic source of truth**: the 7 platform laws, 6 lifecycle stations, 19-agent mesh, handoff contract, HITL gate matrix, 7-surface IA, and milestones M1–M5. Read before any feature, UX, or positioning work. (Personas remain in [`v3-positioning-circuit-2026-06-10.md`](./docs/strategy/v3-positioning-circuit-2026-06-10.md); why v4 exists: [`v4-stress-test-2026-06-11.md`](./docs/strategy/v4-stress-test-2026-06-11.md); session resume: [`docs/planning/v4-rebuild-handoff-2026-06-11.md`](./docs/planning/v4-rebuild-handoff-2026-06-11.md).)
