...
- **Still deferred:** explicit `agent.spawn` fan-out tool + parent merge step (E4 polish), per-mission message-cap loop guard, pause/steer-from-graph controls, F-AGENT-4 (Swarm HUD).
